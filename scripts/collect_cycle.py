...
from collectors import defi_yields, gems_security, news, web3_jobs, whale_movements  # noqa: E402
...
COLLECTORS = {
    ...
    # news last -- no GoPlus/rate-limit interaction, just simplest to append.
    "news": news.collect,
}
